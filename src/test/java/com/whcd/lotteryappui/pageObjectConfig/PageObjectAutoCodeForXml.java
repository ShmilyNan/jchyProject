...
public class PageObjectAutoCodeForXml {
	...
	static  String path="src/test/java/com/whcd/lotteryappui/pageObjectConfig/UILibrary.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("import com.whcd.lotteryappui.pageObjectConfig.PageObjectAutoCodeForXml;");

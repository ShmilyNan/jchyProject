package com.whcd.lotteryappui.pageObjectConfig;

import com.esotericsoftware.yamlbeans.YamlReader;
import com.whcd.lotteryappui.utils.Locator;
import com.whcd.lotteryappui.utils.Log;
...
public class PageObjectAutoCodeForYaml {
	...
	static  String path="src/test/java/com/whcd/lotteryappui/pageObjectConfig/UILibrary.yaml";
	public static void autoCode() throws Exception
	{
		...
		for (int i=0;i<pages.size();i++)
		{
			...
			sb.append("import com.whcd.lotteryappui.utils.BaseAction;\n");
			sb.append("import com.whcd.lotteryappui.utils.Locator;\n");
			sb.append("import com.whcd.lotteryappui.pageObjectConfig.PageObjectAutoCodeForYaml;");
			...
			sb.append("private String path=\"src/test/java/com/whcd/lotteryappui/pageObjectConfig/UILibrary.yaml\";\n");
			sb.append(" public   "
					+ pageClassName
					+ "() {\n");
			...
			File pageObjectFile=new File("src/test/java/com/whcd/lotteryappui/pageObject/"+pageClassName+".java");
	...
	public static void autoCode2() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("import com.whcd.lotteryappui.utils.BaseAction;\n");
			sb.append("import com.whcd.lotteryappui.utils.Locator;\n");
			sb.append("import com.whcd.lotteryappui.pageObjectConfig.PageObjectAutoCode;");
			sb.append("//"+page.attribute(2).getValue()+"_对象库类\n");
			sb.append("public class "+ pageClassName+" extends BaseAction {\n");
			sb.append("//用于eclipse工程内运行查找对象库文件路径\n");
			sb.append("private String path=\"src/test/java/com/whcd/lotteryappui/pageObjectConfig/UILibrary.xml\";\n");

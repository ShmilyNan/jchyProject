package com.whcd.lotteryappui.utils;
...
/**
 * Created by Lance on 2016/12/21 0021.
 */
public class YamlReadUtil {
    public static void main(String args[]) throws FileNotFoundException, YamlException {
        String path="src/test/java/com/whcd/lotteryappui/pageObjectConfig/demo.yaml";
        String path2="src/test/java/com/whcd/lotteryappui/pageObjectConfig/UiLibrary.yaml";
        File file=new File("src/test/java/com/whcd/lotteryappui/pageObjectConfig/UiLibrary.yaml");
        YamlReadUtil yamlReadUtil=new YamlReadUtil();
        yamlReadUtil.getLocatorMap(path2,"com.whcd.lotteryappui.pageObject.StartPage");
        yamlReadUtil.getYamlPageUrl(path2,"com.whcd.lotteryappui.pageObject.StartPage");
    }
